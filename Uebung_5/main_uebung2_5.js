 ...
 */
 uploadButton.addEventListener('click', function(){
    ...
    else {alert("No file has been uploaded");} //message if no file was selected
})
 ...
 */
 ...
 //3. Functions to control the menu bar
